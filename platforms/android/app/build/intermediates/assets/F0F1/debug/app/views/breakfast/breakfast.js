...
http.getJSON("http://app-1506792717.000webhostapp.com/DBMS Project/Breakfast.php").then(function (r)
{
...
http.getJSON("http://app-1506792717.000webhostapp.com/DBMS Project/BreakfastDelivery.php").then(function (r)
{
    for (var i = 0; i< r.length; i++)
        {
        var beer = { 
...
http.getJSON("http://app-1506792717.000webhostapp.com/DBMS Project/BreakfastOutdoor.php").then(function (r)
{
    for (var i = 0; i< r.length; i++)
        {
        var beer = { 
...
http.getJSON("http://app-1506792717.000webhostapp.com/DBMS Project/BreakfastWifi.php").then(function (r)
{
    for (var i = 0; i< r.length; i++)
        {
        var beer = { 
...
http.getJSON("http://app-1506792717.000webhostapp.com/DBMS Project/BreakfastParking.php").then(function (r)
{
    for (var i = 0; i< r.length; i++)
        {
        var beer = { 
...
exports.bttest = function (){
    ...
    http.request({
     ...
     //     http.request({ url: "http://app-1506792717.000webhostapp.com/DBMS.php" }).then(function (response) {
